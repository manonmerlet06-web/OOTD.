          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="order-2 lg:order-1 relative">
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <img src={IMAGES.jacket} className="w-full h-full object-contain mix-blend-multiply" alt="Mix & Match" referrerPolicy="no-referrer" />
                </motion.div>
                <div className="pt-12">
                  <motion.div 
                     whileHover={{ scale: 1.05, rotate: 2 }}
                  ...
                  >
                    <img src={IMAGES.sneakers} className="w-full h-full object-contain mix-blend-multiply" alt="Mix & Match" referrerPolicy="no-referrer" />
                  </motion.div>
                </div>
              </div>
